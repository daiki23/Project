@extends('layouts/template2')
 ...
 <div class="col-lg-12 col-md-12">
        <span style="padding-top: 10px" class="col-md-2">
                <a class="btn btn-block btn-lg btn-success" href="/asisten/web">web</a>
              </span>
              <span style="padding-top: 10px" class="col-md-2">
                <a class="btn btn-block btn-lg btn-danger" href="/asisten/voip">voip</a>
              </span>
              <span style="padding-top: 10px" class="col-md-2">
                <a class="btn btn-block btn-lg btn-success" href="/asisten/ids">ids</a>
              </span>
              <span style="padding-top: 10px" class="col-md-2">
                <a class="btn btn-block btn-lg btn-danger" href="/asisten/gametech">gametech</a>
              </span>
              <span style="padding-top: 10px" class="col-md-2">
                <a class="btn btn-block btn-lg btn-success" href="/asisten/iv">iv</a>
              </span>
              <span style="padding-top: 10px" class="col-md-2">
                <a class="btn btn-block btn-lg btn-danger" href="/asisten/ids">ids</a>
              </span>
...
<img class="img-responsive zoom-img" style="width: 200px;height: 200px" src="{{ URL::to('/image/' . $asisten->gambar) }}"   />
